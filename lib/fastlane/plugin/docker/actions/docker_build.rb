  ...
  module Actions
    ...
    class DockerBuildAction < Action
      def self.run(params)
        ...
        Actions.lane_context[SharedValues::DOCKER_BUILT_IMAGE] = DockerClient.new.build(params[:repository], params[:path],params[:dockerfile], params[:build_args],tag: params[:tag])
